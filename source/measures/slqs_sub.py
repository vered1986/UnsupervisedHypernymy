...
def main():
    ...
    args = docopt("""Compute SLQS Sub for a list of (x, y) pairs and save their scores.
    ...
    Arguments:
        ...
        <output_file> = where to save the results: a tab separated file with x\ty\tlabel\trelation\tscore, where the
                        score is SLQS Sub (for y as the hypernym of x).
   ...
   # Load the term-pairs
    ...
    # Compute SLQS Sub for test tuples
