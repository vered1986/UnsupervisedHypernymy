...
def main():
    ...
    # Get the arguments
    args = docopt("""Compute SLQS Row Sub for a list of (x, y) pairs and save their scores.
    ...
    Arguments:
        ...
        <output_file> = where to save the results: a tab separated file with x\ty\tlabel\trelation\tscore, where the
                        score is SLQS Row Sub (for y as the hypernym of x).
    ...
    # Compute SLQS Sub scores for test tuples
